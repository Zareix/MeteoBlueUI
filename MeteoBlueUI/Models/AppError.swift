...
enum AppError: Error, LocalizedError {
    ...
    var errorDescription: String? {
        ...
        case .noAPIToken: return "No API token found. Please add your API key in Settings."
        case .invalidAPIToken: return "Invalid API token. Please check your API key in Settings."
